...
const RatingPage = ({ onClose,onSubmit }) => {
  ...
  return (
    <div className="rating-page-overlay" onClick={onClose}>
      <div className="rating-page" onClick={(e) => e.stopPropagation()}>
        {/* YOUR EXISTING RATING UI */}
        <div className="feedback">
          <div className="rating">
            ...
            {/* emoji-wrapper stays SAME as your code */}
        ...
        {/* ACTIONS */}
        <div className="rating-page-actions">
